...
{
    public partial class frm_TimKiemHangTonKho : Form
    {
        DataTable dt = null;
        public frm_TimKiemHangTonKho()
        {
            InitializeComponent();
        }
        public DataTable load_dl(string sql)
        {
            ...
            dgvHang.Columns[0].HeaderText = "Mã Kho";
            dgvHang.Columns[1].HeaderText = "Tên Kho";
            dgvHang.Columns[2].HeaderText = "Mã Hàng";
            dgvHang.Columns[3].HeaderText = "Tên Hàng";
            dgvHang.Columns[4].HeaderText = "Số Lượng Nhập";
            dgvHang.Columns[5].HeaderText = "Số Lượng Giao";
            dgvHang.Columns[6].HeaderText = "Tồn Kho";

            dgvHang.Columns[0].Width = 140;
            dgvHang.Columns[1].Width = 200;
            dgvHang.Columns[2].Width = 120;
            dgvHang.Columns[3].Width = 150;
            dgvHang.Columns[4].Width = 120;
            dgvHang.Columns[5].Width = 120;
            dgvHang.Columns[6].Width = 120;

            dgvHang.SelectionMode = DataGridViewSelectionMode.FullRowSelect;
            return dt;
        }
        private void frm_TimKiemHangTonKho_Load(object sender, EventArgs e)
        {
            dt = load_dl("select KHOHANG.MaKho,TenKho,KHOHANG.MaHang,TenHang,SLNhap,SLGiao,TonKho from KHOHANG inner join KHO on KHOHANG.MaKho = KHO.MaKho inner join HANGHOA on HANGHOA.MaHang = KHOHANG.MaHang");
        ...
        {
            txtMa.Enabled = true;
            txtTen.Enabled = txtMaKho.Enabled = false;
            txtTen.ResetText();
            txtMaKho.ResetText();
        }
        ...
        {
            txtTen.Enabled = true;
            txtMa.Enabled = txtMaKho.Enabled = false;
            txtMa.ResetText();
            txtMaKho.ResetText();
        }
        ...
        private void btnTim_Click(object sender, EventArgs e)
        {
            ...
            dt = load_dl("select KHOHANG.MaKho,TenKho,KHOHANG.MaHang,TenHang,SLNhap,SLGiao,TonKho from KHOHANG inner join KHO on KHOHANG.MaKho = KHO.MaKho inner join HANGHOA on HANGHOA.MaHang = KHOHANG.MaHang " + timkiem);
